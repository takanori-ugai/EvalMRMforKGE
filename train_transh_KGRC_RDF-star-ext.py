...
train_dataloader = TrainDataLoader(
	in_path = "./benchmarks/KGRC-RDF-star-ext/", 
	nbatches = 100,
	threads = 8, 
...
# dataloader for test
test_dataloader = TestDataLoader("./benchmarks/KGRC-RDF-star-ext/", "link")
...
trainer.run()
transh.save_checkpoint('./checkpoint/transh_kgrc_rdf-star-ext.ckpt')

# test the model
transh.load_checkpoint('./checkpoint/transh_kgrc_rdf-star-ext.ckpt')
